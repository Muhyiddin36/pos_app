...
<div class="grid grid-cols-3">
    ...
    <div class="card stat-card"><div class="stat-label">Laba Pulsa & Data</div><div class="stat-value text-success"><?= rupiah($totalPulsaProfit) ?></div></div>
    <div class="card stat-card"><div class="stat-label">Total Laba</div><div class="stat-value text-success"><?= rupiah($totalSalesProfit + $totalPulsaProfit) ?></div></div>
</div>
...
<div class="grid grid-cols-2">
    ...
    <div class="card">
        <div class="card-header"><h3>Laba Pulsa & Data per Hari</h3></div>
        <div class="table-wrap">
            <table>
                <thead><tr><th>Tanggal</th><th class="text-right">Omzet</th><th class="text-right">Laba</th></tr></thead>
                <tbody>
